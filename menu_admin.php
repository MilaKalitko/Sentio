...
<header>
    <div class="menu">
        <a href="admin.php" class="logo-link"><img src="./assets/logo.png" alt="Logo de Sentio"></a>
        ...
        <nav id="nav-menu" class="nav">
            <ul class="nav-list">
                ...
                <li><a href="cerrar_sesion.php">Cerrar Sesión (<?php echo $_SESSION['username']; ?>)</a></li>
            </ul>
        </nav>
